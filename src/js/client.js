class Client
{
    ...
    {   
        this.executeCommand(this.server+"register", {"nick":this.name, "pass":this.pass})
            .then(data => {this.checkConnectionResponse(data)})
            .catch(data => {console.log(data); this.connectionFail();});
    }
    ...
    checkConnectionResponse(data)
    {
        if ( "error" in data )
            ...
            this.inter.connectSuccessInterface();
    }
    ...
    executeCommandLeave()
    {
        this.executeCommand(this.server+"leave", {"nick":this.name, "pass":this.pass, "game":this.gameCode})
            .then(data => {this.gameCode = null; this.color = null; this.ignoreServer();})
            .catch(console.log);
    }
